...
function getData_DB() {
			var chart = echarts.init(document.getElementById('results'), 'white', {renderer: 'canvas'});
...
$(function(){
	...
	getData(document.getElementById("kline"));
	genDataset(document.getElementById("kline_dataset"));
